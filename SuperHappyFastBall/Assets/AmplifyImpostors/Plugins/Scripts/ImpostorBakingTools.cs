...
namespace AmplifyImpostors
{
	public static class ImpostorBakingTools
	{
		...
		public static void PreferencesGUI()
		{
			...
			GlobalAlbedoOcclusion = EditorGUILayout.TextField( "Albedo & Alpha", GlobalAlbedoOcclusion );
			...
			GlobalEmissionAlpha = EditorGUILayout.TextField( "Emission & Occlusion", GlobalEmissionAlpha );
			if( GUI.changed )
			{
				...
				EditorPrefs.SetString( PrefGlobalGBuffer0Name, GlobalAlbedoOcclusion );
				...
				EditorPrefs.SetString( PrefGlobalGBuffer3Name, GlobalEmissionAlpha );
			}
		}
		...
		public static void LoadDefaults()
		{
			...
			GlobalAlbedoOcclusion = EditorPrefs.GetString( PrefGlobalGBuffer0Name, "_AlbedoAlpha" );
			...
			GlobalEmissionAlpha = EditorPrefs.GetString( PrefGlobalGBuffer3Name, "_EmissionOcclusion" );
		}
#endif
	}
}
