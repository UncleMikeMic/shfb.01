...
namespace AmplifyShaderEditor
{
	public class TemplateMenuItems
	{
		...
		[ MenuItem( "Assets/Create/Amplify Shader/Hidden/Amplify Impostors", false, 85 )]
		public static void ApplyTemplate7()
		{
			AmplifyShaderEditorWindow.CreateNewTemplateShader( "30a8e337ed84177439ca24b6a5c97cd1" );
		}
